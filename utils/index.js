...
export function interopDefault(promise) {
  return promise.then(m => m.default || m).catch(() => {});
}
...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    ...
    if (process.server) {
      app.context.beforeCoverRender = fn => context.beforeRenderFns.push(fn);
    }
    if (process.client) {
      app.context.coverState = window.__COVER__;
    }
  }
